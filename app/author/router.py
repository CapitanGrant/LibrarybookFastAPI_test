...
async def create_author(author_data: SAuthorBase, session: AsyncSession = TransactionSessionDep) -> dict:
...
async def delete_author_by_id(id: SAuthorID, session: AsyncSession = TransactionSessionDep):
